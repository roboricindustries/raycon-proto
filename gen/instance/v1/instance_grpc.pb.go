...
const (
	ChannelConfigService_GetChannelConfig_FullMethodName = "/instance.v1.ChannelConfigService/GetChannelConfig"
)
...
// UnimplementedChannelConfigServiceServer should be embedded to have
